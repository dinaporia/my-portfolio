                ...
                <div className="col-lg-7 p-0">
                    <div color='medium' className="about-wrapper bg-dark pt-0 pt-lg-7 px-2 pb-2 justify-content-end justify-content-lg-center">
                        <div className='m-auto text-white p-1 p-md-3 px-md-4 py-lg-1'>
                            ...
                            <p className="p-3 mb-0">I am currently a front-end web developer, working towards becoming (MERN) full-stack. I am especially interested in learning about algorithms and making websites that are fully accessible to people with disabilities. My previous lives have included:</p>

                            <ul className='px-4 mb-0 fa-ul'>
                                <li><span className='fa-li'><i className='far fa-sm fa-check-square'/></span>a PhD in Media Studies, where I wrote part of my dissertation as an <a href='https://dinamuhic.com/previous-life/Ring-Around-the-Rosie.html' target='_blank' rel='noreferrer'>interactive choose-your-own-adventure digital module</a>
                                </li>
