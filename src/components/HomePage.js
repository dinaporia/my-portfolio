    ...
    return (
        <div className="row h-100">
            ...
            <div className="col-lg-4 p-0">
                ...
                <p className="wrapped-text">I create responsive websites using HTML, CSS, and JavaScript. I prefer Sass and Bootstrap for my styling needs, and I've grown to love React/React Native for its reusable components.</p>
